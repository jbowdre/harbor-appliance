...
variable "builder_host_contentlibrary" {
  type = string
  default   = "lab-library"
}
...
variable "builder_vcenter_datacenter" {
  type      = string
  default   = "Lab"
}
...
source "vsphere-iso" "autogenerated_1" {
  ...
  datacenter                = "${var.builder_vcenter_datacenter}"
  ...
  #   library = "${var.builder_host_contentlibrary}"
  #   destroy = true
  #   ovf = true
  # }
}
